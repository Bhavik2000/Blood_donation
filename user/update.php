...
// term input check
	...
	// insert in to database
			if(isset($name)&&isset($month)&&isset($date)&&isset($email)&&isset($year)&&isset($blood_group)&&isset($contact_no)&&isset($city)&&isset($gender)){
					$dob= $date."-".$month."-".$year;
					
					$sql = "UPDATE `donor` SET `name`='$name',`gender`='$gender',`email`='$email',`city`='$city',`dob`='$dob',`contact_no`='$contact_no',`blood_group`='$blood_group' WHERE id=".$_SESSION['user_id'];
					...
					if(mysqli_query($connection,$sql)){
							...
							<?php
						  		...
						  		<strong>Data is not update try again...</strong>
						 		<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						    	<span aria-hidden="true">&times;</span>
						 		</button>
								</div>';
  			...
  			if(isset($_POST['old_password']) && !empty($_POST['old_password'])&&isset($_POST['c_password']) && !empty($_POST['c_password'])&&isset($_POST['new_password']) && !empty($_POST['new_password'])){
  				...
  				if($oldpassword==$dbpassword){
  					if(strlen($_POST['new_password'])>=6){
		  					if( $_POST['new_password']==$_POST['c_password']){
							 	...
							 	<strong>New_Password  & confim_password are not same...</strong>
							 	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
							  	<span aria-hidden="true">&times;</span>
								</button>
								</div>';
  				...
  				if(isset($password)){
  					...
  					$sql="UPDATE donor SET password='$password' WHERE id=".$_SESSION['user_id'];
							...
							$updatepassword= '<div class="alert alert-success alert-dismissible fade show" role="alert">
									...
									<?php
								 	...
								 	$updateerror= '<div class="alert alert-danger alert-dismissible fade show" role="alert">
							  		<strong>Oops!..No update data try again...</strong>
							 		<button type="button" class="close" data-dismiss="alert" aria-label="Close">
							   	 	<span aria-hidden="true">&times;</span>
							 	 	</button>
									</div>';
...
<style>
		...
		padding: 20px 10px 20px 30px;
			...
			<div class="row">
              ...
              <?php if(isset($blood_grouperror)) echo"$blood_grouperror";?>
					...
					<div class="form-group">
				              <label for="gender">Gender</label><br>
				              		Male<input type="radio" name="gender" id="gender" value="Male" style="margin-left:10px; margin-right:10px;" <?php if($gender=="Male") echo"checked"?>>
              ...
              <select class="form-control demo-default" id="date" name="date" style="margin-bottom:10px;" required>
              	  <?php if(isset($Birth['0'])) echo'<option selected="" value="'.$Birth['0'].'">'.$Birth['0'].'</option>'; ?>
                ...
                <option value="01" >01</option><option value="02" >02</option><option value="03" >03</option><option value="04" >04</option><option value="05" >05</option><option value="06" >06</option><option value="07" >07</option> <option value="08" >08</option><option value="09" >09</option><option value="10" >10</option><option value="11" >11</option><option value="12" >12</option><option value="13" >13</option><option value="14" >14</option><option value="15" >15</option><option value="16" >16</option><option value="17" >17</option><option value="18" >18</option><option value="19" >19</option><option value="20" >20</option><option value="21" >21</option><option value="22" >22</option><option value="23" >23</option><option value="24" >24</option><option value="25" >25</option><option value="26" >26</option><option value="27" >27</option><option value="28" >28</option><option value="29" >29</option><option value="30" >30</option><option value="31" >31</option>
              	  ...
              	  <?php if(isset($Birth['1'])) echo'<option selected="" value="'.$Birth['1'].'">'.$Birth['1'].'</option>'; ?>
				...
				<td>
				 <select class="form-control demo-default" id="year" name="year" style="margin-bottom:10px;" required>
              	  <?php if(isset($Birth['2'])) echo'<option selected="" value="'.$Birth['2'].'">'.$Birth['2'].'</option>'; ?>
	...
	<option value="">-- Select --</option>
	 ...
	 <?php if(isset($cityerror)) echo"$cityerror";?>
            ...
            <div class="form-group">
						<button id="submit" name="submit" type="submit" class="btn btn-lg btn-danger center-aligned" style="margin-top: 20px;">Update Profile</button>
					</div>
				</form>
					</div>
				</div>
				<div class="card col-md-6 offset-md-3">
					...
					<!-- Messages -->	
						...
						<form action="" method="post" class="form-group form-container" >
							...
							if(isset($updatepassword)) echo"$updatepassword";
							?>
							<div class="form-group">
