<?php
	...
	$connection = mysqli_connect("localhost","root","","donateblood") or die("Database can not connected".mysqli_connect_error());
						...
						if(mysqli_num_rows($result)>0){
							...
							while($row=mysqli_fetch_assoc($result)){
								...
								if($row['save_life_date']=='0'){
									echo '<div class="col-md-5 col-sm-12 col-lg-4 donors_data">
